...
const SubTotal = () => {
    let total = 0;
    listCart.value.map((itemcart) => {
        total += itemcart.quantity * itemcart.unit_price;
    });
    return total;
};
...
<template>
        ...
        <div class="card__content">
            ...
            <div class="table">
                ...
                <div class="table--items2" v-for="(itemcart, i) in listCart" :key="itemcart.id">
                    ...
                    <p v-if="itemcart.quantity && itemcart.unit_price">
    ...
    <div class="modal main__modal " :class="{show: showModal}">
        <div class="modal__content">
            ...
            <hr><br>
            <div class="modal__items" @click="closeModal()">
